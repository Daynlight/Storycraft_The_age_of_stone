...
pub fn set(
  ...
  *systems = scenes::register::RunningSystemsRegister{
  ...
  // edge boxes
  let position = Vec2::new(310.0, 170.0);
  let edge_size = 50.0;
  ...
  //// add boxes
  let generate_position = position - Vec2::new(50.0, 50.0);
  let generate_direction = position - Vec2::new(100.0, 100.0);
